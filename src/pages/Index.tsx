            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-4 space-y-4 text-sm">
                <label className="block">
                  <span className="font-medium text-slate-700">Loan Start Date</span>
                  <input
                    type="month"
                    value={loanStart}
                    onChange={(e) => setLoanStart(e.target.value)}
                    className="mt-2 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                  />
                </label>

                <label className="block">
                  <span className="font-medium text-slate-700">Original Loan Amount</span>
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-white py-2 pl-7 pr-3 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                    />
                  </div>
                ...
                <label className="block">
                  <span className="font-medium text-slate-700">Interest Rate (Annual %)</span>
                  <div className="relative mt-2">
                    <input
                      type="number"
                      step="0.125"
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-white py-2 pl-3 pr-10 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                    />
                ...
                <label className="block">
                  <span className="font-medium text-slate-700">Loan Term (Years)</span>
                  <input
                    type="number"
                    value={years}
                ...
                <div className="space-y-2 border-t border-slate-100 pt-4">
                  ...
                  <label className="block">
                    <span className="font-medium text-slate-700">Extra Payment Start Date</span>
                    <input
                      type="month"
                      value={extraStart}
